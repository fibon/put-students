...
public class RandomClassifierTest {
	...
	private RandomClassifier classifier = new RandomClassifier();
	...
	public void test_random() throws Exception {
		...
		resultListener.setOutputFile(new File("target/random_classifier_test_random.txt"));
	...
	public void test_crossvalidation() throws Exception {
		...
		producer.setSplitEvaluator(evaluator);
		producer.setResultListener(resultListener);
		resultListener.setOutputFile(new File("target/random_classifier_test_crossvalidation.txt"));
	...
	public void test_training_test() throws Exception {
		...
		producer.setSplitEvaluator(evaluator);
		producer.setResultListener(resultListener);
		resultListener.setOutputFile(new File("target/random_classifier_test_training_test.txt"));
